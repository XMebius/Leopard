...
/*!
 * Configure the window for displaying tj leopard
 */
size_t Graphics3D::setupTJLeopard(Vec4<float> color, bool useOld, bool canHide) { return _drawList.addTJLeopard(color, useOld, canHide); }
